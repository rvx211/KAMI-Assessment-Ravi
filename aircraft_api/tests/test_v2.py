...
class AircraftAPITest(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.user = User.objects.create_user(
            username="logintest02", email="logintest02@email.com", password="&$P4ssw0rdl01")
        ...
        self.aircraft_list_6 = json.dumps({'aircraft': [
            {'aircraft_id': 11, 'aircraft_passenger': 200},
            {'aircraft_id': 12, 'aircraft_passenger': 200},
            {'aircraft_id': 13, 'aircraft_passenger': 200},
            {'aircraft_id': 14, 'aircraft_passenger': 200},
            {'aircraft_id': 15, 'aircraft_passenger': 200},
            {'aircraft_id': 16, 'aircraft_passenger': 200},
            {'aircraft_id': 17, 'aircraft_passenger': 200},
            {'aircraft_id': 18, 'aircraft_passenger': 200},
            {'aircraft_id': 19, 'aircraft_passenger': 200},
            {'aircraft_id': 20, 'aircraft_passenger': 200}
        ]})
