...
class AircraftAPITest(APITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.aircraft_unit_1 = {'aircraft_id': None, 'aircraft_passenger': 100}
        self.aircraft_unit_2 = {'aircraft_id': 2, 'aircraft_passenger': None}
        ...
        self.aircraft_list_2 = {'aircraft': [
            {'aircraft_id': None, 'aircraft_passenger': 100},
        ...
        self.aircraft_list_3 = {'aircraft': [
            {'aircraft_id': 10, 'aircraft_passenger': None},
            {'aircraft_id': 1, 'aircraft_passenger': 200},
            {'aircraft_id': 2, 'aircraft_passenger': 200},
            {'aircraft_id': 3, 'aircraft_passenger': 200},
            {'aircraft_id': 4, 'aircraft_passenger': 200},
    ...
    def test_aircraft_unit_empty_id(self):
        ...
        self.assertEqual(response.data['detail'], AircraftIDEmptyException.detail)
    ...
    def test_aircraft_unit_empty_passenger(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.data['detail'], AircraftPassengerEmptyException.detail)
    ...
    def test_aircraft_unit_invalid_id(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.data['detail'], AircraftIDNotInteger.detail)
    ...
    def test_aircraft_unit_invalid_passenger(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.data['detail'], AircraftPassengerNotInteger.detail)
    ...
    def test_aircraft_unit_valid_data(self):
        ...
        self.assertEqual(response.data['aircraft_total_fuel_consumption_per_minute'], total_fc_per_minute)
        self.assertEqual(response.data['aircraft_maximum_flight_time_in_minutes'], max_flight_minutes_time)
    ...
    def test_aircraft_list_empty(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.data['detail'], AircraftListEmptyException.detail)
    ...
    def test_aircraft_unit_valid_data(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        for aircraft in response.data['aircraft']:
